...
#        self.flg_topic = "synthesis_flg"
    ...
    def depth_callback(self, msg):
        self.depth = float32_to_numpy(msg)      

    def instseg_callback(self, msg):
        self.bbox_stem = float32_to_numpy(msg.bbox_stem)
        self.bbox_tomato = float32_to_numpy(msg.bbox_tomato)
        self.bbox_pedicel = float32_to_numpy(msg.bbox_pedicel)
        self.bbox_sepal = float32_to_numpy(msg.bbox_sepal)
        self.mask_stem = float32_to_numpy(msg.mask_stem)
        self.mask_tomato = float32_to_numpy(msg.mask_tomato)
        self.mask_pedicel = float32_to_numpy(msg.mask_pedicel)
        self.mask_sepal = float32_to_numpy(msg.mask_sepal)
